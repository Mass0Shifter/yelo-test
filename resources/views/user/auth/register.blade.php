    ...
    <form role="form" method="POST" action="{{ url('/register') }}">
      ...
      <div class="white">
        ...
        <div class="form-group">
          ...
          <input type="password" name="password" required class="form-control" id="pwd"  placeholder="Create your Account Password">
        </div>  
        <div class="form-group">
          <label for="pwd">{{tr('confirm_password')}}</label>
          <input type="password" name="password_confirmation" required class="form-control" id="pwd"  placeholder="Confirm your Account Password">
        </div>
      </div>        
      <br>          
